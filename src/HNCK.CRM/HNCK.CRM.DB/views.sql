...
/*  Created On : 14-máj-2022 22:27:31 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */
...
DROP VIEW IF EXISTS sub."Countries" CASCADE
;
...
left join 
	sub."Country" c on c."IdCountry" = a."IdCountry"
left join 
	sub."Country" c2 on c2."IdCountry" = s."IdNationality"
where a."IdAddressType" = 1 or a."IdAddressType" is null
group by s."IdSubject", c2."NameSK";
;
