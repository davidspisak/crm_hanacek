...
/*  Created On : 14-máj-2022 22:25:27 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */
...
DROP SEQUENCE IF EXISTS evn.userevent_iduserevent_seq
;
...
DROP TABLE IF EXISTS evn."UserEvent" CASCADE
;
...
(
	...
	"PersonalIdentificationNumber" varchar(127) NULL,
	"BusinessIdentificationNumber" varchar(127) NULL,
...
CREATE TABLE evn."UserEvent"
(
	"IdUserEvent" integer NOT NULL   DEFAULT NEXTVAL(('evn."userevent_iduserevent_seq"'::text)::regclass),
	"Name" varchar(255) NOT NULL,
	"Decsription" varchar(1023) NULL,
	"DueDate" timestamp without time zone NOT NULL,
	"NotificationDate" timestamp without time zone NULL,
...
CREATE INDEX "IXFK_Subject_Country" ON sub."Subject" ("IdNationality" ASC)
;
...
ALTER TABLE evn."UserEvent" ADD CONSTRAINT "PK_UserEvent"
	PRIMARY KEY ("IdUserEvent")
;

CREATE INDEX "IXFK_UserEvent_Subject" ON evn."UserEvent" ("IdSubject" ASC)
;
...
ALTER TABLE sub."Subject" ADD CONSTRAINT "FK_Subject_Country"
	FOREIGN KEY ("IdNationality") REFERENCES sub."Country" ("IdCountry") ON DELETE No Action ON UPDATE No Action
;
...
ALTER TABLE evn."UserEvent" ADD CONSTRAINT "FK_UserEvent_Subject"
	FOREIGN KEY ("IdSubject") REFERENCES sub."Subject" ("IdSubject") ON DELETE No Action ON UPDATE No Action
;
...
CREATE SEQUENCE evn.userevent_iduserevent_seq INCREMENT 1 START 1
;
